...
class TestSubscribe(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        # Mock the CertificateRotator class for testing
        cls.mock_certRotatorApp = MagicMock()
        # Mock event object
        ...
        cls.subscribe = Subscribe(
            ...
            certRotatorApp=cls.mock_certRotatorApp
        )
    ...
    def test_on_stream_event(self):
        ...
        # Assert that the certRotatorApp.callback_message method is called with the correct arguments
        self.subscribe.certRotatorApp.callback_message.assert_called_once_with(
            "topic",
            "world"
        )
